...
def connect_to_vstore():
    ...
    ASTRA_DB_APPLICAION_TOKEN = os.getenv("ASTRA_DB_APPLICAION_TOKEN")
    ...
    vstore = AstraDBVectorStore(
        ...
        token=ASTRA_DB_APPLICAION_TOKEN,
...
retreiver = vstore.as_retriever(search_kwargs={"k":3})
...
prompt = hub.pull("hwcase17/open-ai-functions-agent")
llm = ChatOpenAI()
...
while(question := input("Ask a question about github issues (q to quit): ")):
